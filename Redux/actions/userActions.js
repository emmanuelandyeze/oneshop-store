	...
	(email, password) => async (dispatch) => {
		try {
			...
			const { data } = await axios.post(
				'https://oneshopadmin.herokuapp.com/api/users/login',
				{ email, password },
				config,
			);
...
export const register =
	(name, email, password) => async (dispatch) => {
		try {
			...
			const { data } = await axios.post(
				'https://oneshopadmin.herokuapp.com/api/users',
				{ name, email, password },
				config,
			);
	...
	(id) => async (dispatch, getState) => {
		try {
			...
			const { data } = await axios.get(
				`https://oneshopadmin.herokuapp.com/api/users/${id}`,
				config,
			);
...
export const loadUser =
	(token) => async (dispatch, getState) => {
		try {
			...
			const { data } = await axios.get(
				`https://oneshopadmin.herokuapp.com/api/users/profile`,
			);
...
export const updateUser =
	(user) => async (dispatch, getState) => {
		try {
			...
			const { data } = await axios.put(
				`https://oneshopadmin.herokuapp.com/api/users/${user._id}`,
				user,
				config,
			);
